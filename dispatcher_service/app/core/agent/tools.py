...
def read_file(file_path=None):
    # Previously this was reading from a relative "output" directory from wherever
    # the script was run. Now we'll read from the core/output directory specifically
